...
import { doRemoveSubscriptionNotifications } from 'redux/actions/subscriptions';
...
const perform = dispatch => ({
  ...
  removeSubscriptionNotifications: (channel, uri) => dispatch(doRemoveSubscriptionNotifications(channel, uri))
});
